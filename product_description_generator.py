...
class ProductDescriptionGenerator:
    ...
    def product_description_content(self):
        try:
            ...
            message = f'Something went wrong with product description content, message: {e}'
            logging.error(message)


content = ProductDescriptionGenerator()
print(content.product_description_content())
